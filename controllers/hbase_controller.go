...
import (
	...
	hbasev1 "github.com/juiceco/api/v1"
...
// +kubebuilder:rbac:groups=hbase.shimerhe.co,namespace="hbase",resources=hbases,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hbase.shimerhe.co,namespace="hbase",resources=hbases/status,verbs=get;update;patch
